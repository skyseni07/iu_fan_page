...
function Create(props) {
  return <article>
    <form onSubmit={e => {
      ...
      <p>
        <input type="submit" value="Create" className='content_btn create_btn' />
      </p>
    </form>
  </article>
}
...
function List(props) {
  return <header>
    <a href="#" className='btn list_btn' onClick={(event) => {
...
const NewsBoard = (props) => {
  ...
  const [topics, setTopics] = useState(NewsData.data);
